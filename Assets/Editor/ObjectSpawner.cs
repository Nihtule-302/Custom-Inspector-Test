...
namespace Editor
{
    public class ObjectSpawner : EditorWindow
    {
        ...
        private bool _showColorList;
        private List<Color> _colors = new List<Color> { Color.red, Color.blue, Color.green};
        ...
        private void OnGUI()
        {
            ...
            GeneralTools.AddSpaceBetweenSections(2);
        
            DrawColorSection();

            GeneralTools.AddSpaceBetweenSections(4);
        ...
        private void DrawColorSection()
        {
            ...
            DrawColorList();
            GeneralTools.AddSpaceBetweenSections();
            DrawAddNewColor();
        }
